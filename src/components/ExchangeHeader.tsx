  ...
  return (
    <div className="flex justify-between mb-4 space-x-3 items-center">
      <div className="grid grid-cols-3 rounded p-3px h-[46px]">
        <NavLink
          activeClassName="font-bold border rounded text-high-emphesis border-gradient"
          href={{
            pathname: '/swap',
            query: getQuery(input, output),
          }}
        >
          <a className="flex items-center justify-center px-4 text-base font-medium text-center rounded-md text-white bg-dark-800 mr-1.5">
            {i18n._(t`Swap`)}
          </a>
        </NavLink>
        <NavLink
        ...
        >
          <a className="flex items-center justify-center px-4 text-base font-medium text-center rounded-md text-white bg-dark-800">
            {i18n._(t`Liquidity`)}
          </a>
        </NavLink>
      </div>
